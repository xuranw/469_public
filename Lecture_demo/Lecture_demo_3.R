...
xgb_cv <- xgboost::xgb.cv(data = train_dat, label = train_label,
                          ...
                          max_depth = max_depth, objective = "bixnary:logistic", early_stopping_rounds = 10)
...
## early_stoppping_rounds (when to stop if the
...
xgb_fit$evaluation_log # the training -log(likelihood)
